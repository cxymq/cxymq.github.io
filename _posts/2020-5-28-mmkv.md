...
**然后**，下载老版本的 Simulator。
![download-simulator.png](https://github.com/cxymq/cxymq.github.io/blob/master/_images/2020-5-28/download-simulator.png)

**最后**，选择模拟器(如：iphone 11 支持x86_64，iphone 5 支持i386)，Cmd+B 编译。
Products --> 右键show in finder
![framework.png](https://github.com/cxymq/cxymq.github.io/blob/master/_images/2020-5-28/framework.png)
...
![crash-1.png](https://github.com/cxymq/cxymq.github.io/blob/master/_images/2020-5-28/crash-1.png)

将framework修改成如下：
![slove-1.png](https://github.com/cxymq/cxymq.github.io/blob/master/_images/2020-5-28/slove-1.png)
